...
<li class="item first" id="one"><a href="/cinema ticket/reservation/seatreservation/admin/dashboard1.php" class="main current"><span class="outer"><span class="inner reports">veiw orders</span></span></a></li>        
