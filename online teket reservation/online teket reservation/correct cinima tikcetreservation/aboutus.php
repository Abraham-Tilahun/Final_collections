...
<div align="center">
						<h1> HIBRET HOTEL CINEMA  </h1>
	           * contact to in HIBRET HOTEL CINEMA in front of Debre Tabor bus station<br> 
			, you can contact us via email.  See our email address(hibretcinema@gmail.com) .<br>
            And you can directly contacting us. +251919856766 <br>
                           <h3>Attention !!!!!!</h3>
						   <ul>
            <li>.Any custemer can access or reserve to watch the<br>
		         movie before the 30 minutes for watch reserves. </li>
            <li>.Any reserve customer can not enter without ticket.</li>
            <li>. After started watch movie you can not entered. </li>
            <li>  switch off your mobile!!!!!.</li>
             <li>.impossible talking ,smoking ,and recording the movie</li> 
              <li>.any reserve customer  shoud be seat based on seat number</li>
			  </ul>
