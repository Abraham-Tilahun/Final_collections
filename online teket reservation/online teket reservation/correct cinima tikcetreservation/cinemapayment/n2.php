...
<form action="n2.php" method="post" >
	...
	<font color=white >BrandName <select name="brand" maximumsize=20px>
	<option selected=selected>All</option>
	<option>Acer</option>
	<option>Dell</option>
	</select>
<input type='submit' value='Go' name='submitMain' />
</form>
<h1><p align=center><font color=white size=5 >Desktop</font></h1>
<?php
	if(isset($_POST['brand']))
 {
$brand=$_POST['brand'];
if($brand=='All'){
$result2 = mysql_query("SELECT * FROM products where product_name='Desktop'");
...
$result2 = mysql_query("SELECT * FROM products where product_name='Desktop' and BrandName='$brand'");
...
<div align="center">
		...
		<?php
							...
							/*	$result2 = mysql_query("SELECT * FROM products where product_name='Laptop'");
