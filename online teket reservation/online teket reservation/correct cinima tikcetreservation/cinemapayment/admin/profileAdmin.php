...
?>	
	...
	<li class="item first" id="one"><a href="/cinema ticket/reservation/seatreservation/admin/dashboard.php" class="main current"><span class="outer"><span class="inner newsletter">SEAT INFO</span></span></a></li>
