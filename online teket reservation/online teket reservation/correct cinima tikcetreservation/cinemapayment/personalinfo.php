...
<tr><td style="font-size:20px;color:black;background:tan;">for feedback</td></tr>
...
<!--<input type="hidden" name="movie" id="name" value="<?php echo $_POST['movie_id'] ?>" />-->
...
<tr>
<td colspan=2>
<h1 align=center>Reserver Information form</h1>
</td></tr>
<tr><td>
<label>First Name
...
<input type="text" name="llname" id="txt_last" pattern="\D{1,15}" required x-moz-errormessage="Please Enter Movie Name Only  Letter" title="Please Enter Movie Name Only  Letter" />
</td></tr>
<tr><td>
<label>Email
...
<input type="text" name="street" id="street" pattern="\d{1,10}" required x-moz-errormessage="Please Enter Check the ID Number" title="Please Enter Check the ID Number" placeholder='ID No'/>
</td></tr><!--
<tr><td>
<label>House No.
...
<option value="1:00pm">1:00am</option>
            <option value="1:15pm">2:00am</option>
            <option value="1:30pm">3:00am</option>
            <option value="1:45pm">4:00am</option>
            <option value="2:00pm">5:00am</option>
            <option value="2:15pm">6:00am</option>
            <option value="2:30pm">7:00am</option>
            <option value="2:45pm">8:00am</option>
            <option value="3:00pm">9:00am</option>
            <option value="3:15pm">10:00am</option>
            <option value="3:30pm">11:00am</option>
            <option value="3:45pm">12:00am</option>
            <option value="4:00pm">1:00pm</option>
            <option value="4:15pm">2:00pm</option>
            <option value="4:30pm">3:00pm</option>
            <option value="4:45pm">4:00pm</option>
            <option value="5:00pm">5:00pm</option>
            <option value="5:15pm">6:00pm</option>
            <option value="5:30pm">7:00pm</option>
            <option value="5:45pm">8:00pm</option>
            <option value="6:00pm">9:00pm</option>
            <option value="8:00pm">10:00pm</option>
            <option value="11:00pm">11:00pm</option>
            <option value="12:00am">12:00am</option>
          </select>
</td></tr>
<tr><td><label>Reserved Date

</label></td><td> 
<span style="margin-right: 5px;"  >
 <input type="text" class="w8em format-y-m-d highligssht-days-67 range-low-today" 
 
 placeholder="Reserved Date"  required x-moz-errormessage="Please Enter Reserved Date" title="Please Enter Reserved Date " name="ddate" id="sd" value=""  readonly 
...
<font color=white size=4px ><p align=center>ROUP 7 $copy;2009/2017 HibretHotelCinema &reg;All RIghts ReservedGroup @DEBRE TABOR UNIVERSITY.</p>
</td>
</tr>
