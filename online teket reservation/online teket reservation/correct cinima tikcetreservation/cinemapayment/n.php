...
<form action="n.php" method="post" >
	...
	<font color=white >BrandName <select name="brand">
...
<h1><p align=center><font color=white size=5 >Laptop</font></h1>
<div class="view1">
<?php
...
$result2 = mysql_query("SELECT * FROM products where product_name='Laptop' and BrandName='$brand'");
