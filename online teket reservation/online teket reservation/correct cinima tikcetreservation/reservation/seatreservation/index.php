...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php"><img src="../../image/11.PNG" alt="" /></a></h1>
        <ul id="mainnav">
	...
	<div id="footer">
	<a href="index.php"><img src="../../image/HH.PNG" alt="James Buchanan Pub and Restaurant" /></a>
	<p>&copy; Copyright 2009/2017 HIBRET HOTEL CINEMA @DEBRE TABOR UNIVERSUTY | &reg;All Rights Reserved <br /></p>
</div>
</div>
</body>
</html>
