...
var b=document.forms["addroom"]["movie_name"].value;
if (b==null || b=="")
  {
...
<form action="addexec.php" method="post">
	Movie Type:<br><input type="text" name="type" class="ed"><br>
	Movie Nmae:<br><input type="text" name="movie_name" class="ed"><br>
