...
<body>
	<div id="container">
		<div id="adminba-outer" class="radius-bottom">
			<div id="adminba" class="radius-bottom">
				<a id="logo" href="reserver information.php"></a>
				<div id="details">
					...
					!
					<br>
					<a class="alightred" href="/cinema ticket/index.php">Logout</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					<a class="alightred" href="/cinema ticket/customer/veiwseat.php">Back</a>&nbsp&nbsp&nbsp&nbsp&nbsp
					<a class="alightred"href="/cinema ticket/cinemapayment/order.php" title="">order</a></li>
		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				...
				Reserved seat information
					<!--<li>
						<a class="active" href="reserver information.php">-->
						<!--	<img alt="Dashboard" src="img/m-reserver information.png">-->
							<span></span>						</a>					</li>
				...
				<div id="footer" class="radius-bottom">
					...
					<a class="afooter-link" href="">GROUP 7,&copy;2009/2017, HibretHotelCinema&reg; All RIghts Reserved @DEBRE TABOR UNIVERSITY<br>
 </a>
