...
while($row = mysql_fetch_array($result))
	...
	$payable=$qty*$price;
mysql_query("INSERT INTO customer (fname, lname, address, contact, movie_type, transactionum, payable, setnumber)
VALUES ('$fname', '$lname', '$address', '$contact', '$busnum', '$confirmation','$payable','$setnum')");
mysql_query("INSERT INTO reserve (date, movie_type, seat_reserve, transactionnum, seat)
