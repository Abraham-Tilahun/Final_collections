...
<link rel="stylesheet" type="text/css" href="css/blue.css" />
	...
	<td >
		<img src="admin.php" alt="" width=910 height=110>
<?php 
...
?>		</td>
	...
	<ul class="group" id="menu_group_main">
		...
		<li class="item first" id="four"><a href="search_news.php" class="main"><span class="outer"><span class="inner media_library">search_news</span></span></a></li>  
...
echo"
<form action='/cinema ticket/admin/manager/profileAdmin.php' method='POST'>
