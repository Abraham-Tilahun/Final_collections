...
<link rel="icon" type="image/ico" href="images/App Icon.ico"/></head>
...
<strong>HIBRET HOTEL CINEMA ONLINE TICKET BOOKING</strong><br>Debre Tabor Tawn<br>Email Us: hibretcinema@gmail.com<br>call on <a href="#">(+251)919856766</a>
<br><br><br><br>
<?php
include("includes/db.php");
		...
		while($row = mysql_fetch_array($result))
			{
				echo 'Reserved Date: '.$row['delivery_date'].'<br>';
				echo 'Movie Name: '.$row['firstname'].' '.$row['lastname'].'<br>';
				...
				echo 'ID No: '.$row['street'].'<br>';
				//echo 'House number: '.$row['houseno'].'<br>';
				echo 'Movie seen Time: '.$row['time'].'<br>';
...
<table cellpadding="5" cellspacing="0" id="resultTable" border="1" width="100%">
		<tr>
			...
			<td> <strong>NO_Reserver</strong> </td>
...
<a href="../reservation/seatreservation/index.php">ReserveTicket</a>