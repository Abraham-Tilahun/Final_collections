...
<?php 
echo '<p align=right style="margin-right:3%;">'.'<img src="images1/User3.png" width=50px height=25px/>'."&nbsp;".'<font color=black>'.'Hi,'."&nbsp;".$FirstName."&nbsp;".$middleName." ".'<a href="/cinema ticket/logout.php" onClick="isConfirmloggg();">logout</a>'.'<a href="http://www.facebook.com" target=_blank ><img src="">&nbsp;</a>'.
...
<input type='hidden' name='transfer' id='tra' value='Hibret Hotel' />
...
while($row = mysql_fetch_array($re))
 ...
 $de = mysql_query("DELETE from orders WHERE confirmation='$transnum'",$conn2) or die(mysql_error());
  ...
  $sql=mysql_query("INSERT INTO reservation (movie_id,firstname, lastname, email, payable,status, confirmation,  payed_date, time, payment, delivery_type) 
VALUES ('$product','$ffname','$lname','$email','$total','$status','$transnum','$ddate','$time','$pmethod','$dmethod')");
