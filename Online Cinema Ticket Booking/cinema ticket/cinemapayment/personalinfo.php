...
{
alert ('pls. agree the term and condition of this cinemacompany');
return false;
}
else
{
...
<a href="../cinemapayment/order.php" title="">Back</a>
...
'<a href="http://www.twitter.com" target="_blank"><img src="">&nbsp;'.'<a href="http://www.google.com" target="_blank"><img src="">&nbsp;'.'</font>';
