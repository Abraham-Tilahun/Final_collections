...
?>	
	...
	<li class="item first" id="one"><a href="../../cinemapayment/admin/message.php" class="main current"><span class="outer"><span class="inner newsletter">Message</span></span></a></li>
	 <li class="item first" id="one"><a href="cinema ticket/cinemapayment/admin/movie.php" class="main"><span class="outer"><span class="inner content">Add Movi</span></span></a></li>
	<li class="item first" id="one"><a href="/cinema ticket/reservation/seatreservation/admin/seatinformation.php" class="main current"><span class="outer"><span class="inner newsletter">SEAT INFO</span></span></a></li>
