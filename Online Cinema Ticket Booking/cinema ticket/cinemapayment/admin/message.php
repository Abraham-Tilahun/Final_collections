...
<link rel="stylesheet" type="text/css" href="css/blue.css" />
	...
	<tr>
	<td style="background:url('../images1/wrapsper-bg.png');" width=910 height=91 >
	<?php 
...
?>		</td>
	...
	<ul class="group" id="menu_group_main">
				...
				<li class="item first" id="four"><a href="../../reservation/seatreservation/admin/reserver information.php" class="main"><span class="outer"><span class="inner media_library">seat information</span></span></a></li>  
	...
	<li class="item first" id="one"><a href="/cinema ticket/cinemapayment/admin/movie.php" class="main current"><span class="outer"><span class="inner content"">Add Movie</span></span></a></li>
	</ul>
</div>
</td>
</tr>
