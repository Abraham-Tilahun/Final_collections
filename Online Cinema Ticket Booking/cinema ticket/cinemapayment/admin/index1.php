...
?>	
	...
	<ul class="group" id="menu_group_main">
		<li class="item first" id="one"><a href="index1.php" class="main"><span class="outer"><span class="inner dashboard1">Order</span></span></a></li>
...
<td id="table1">
		...
		<div class="portlet-header fixed"><img src="images/icons/user.gif" width="16" height="16" alt="Latest Registered Users" /> 
			...
			<label for="filter">Search</label> <input type="text" name="filter" value="" id="filter" /><br>
			
			</div>
		<form action="" method="post">
			
			<table cellpadding="1" cellspacing="1" id="table1" border=1>
					...
					while($row = mysql_fetch_array($result))
						{
							...
							<a rel="facebox" href="vieworders.php?id='.$row['confirmation'].'" title="Click To View Orders">View Orders</a></td>';
							echo '</tr>';
						}
					?> 
				</tbody>
