...
<link rel="stylesheet" type="text/css" href="css/blue.css" />
	...
	f<table  width="930"  align=center >
...
?>	
	...
	<ul class="group" id="menu_group_main">
		<li class="item first" id="eight"><a href="movie.php" class="main current"><span class="outer"><span class="inner settings">Movie</span></span></a></li>
	...
	<li class="item first" id="one"><a href="../../admin/manager/changepass.php" class="main current"><span class="outer"><span class="inner newsletter">Change Password</span></span></a></li>
		<li class="item first" id="one"><a href="../../reservation/seatreservation/admin/seatinformation.php" class="main current"><span class="outer"><span class="inner newsletter">About Movie</span></span></a></li>
...
<td id="table1">
		...
		<div class="portlet-header fixed"><img src="images/icons/user.gif" width="16" height="16" alt="Latest Registered Users" /> 
			...
			<a rel="facebox" href="addproduct.php"><b>Add Movie</b></a>
			</div>
