...
<div id="content">
                  ...
                  <form  type="multipart/form-data" name="myForm" action="blockregistration.php" method="post" onsubmit="return (Register());" >
		     ...
		     while($search=mysql_fetch_array($retval))
			  ...
			  ?>
				...
				<tr>
					<td height="33"> &nbsp;&nbsp;Block Name :</td><td><input type="text" name="bn" size="18" pattern="[a-zA-Z]+"
					oninvalid="setCustomValidity('room Number is required')" onChange="try{setCustomValidity('')} catch(e){}" required="required"></td><br />
				</tr>
				<tr>
					<td height="33"> &nbsp;&nbsp;Number of Room :</td><td><input type="text" name="nr" size="18" pattern="[0-9]+"
					oninvalid="setCustomValidity('room Number is required')" onChange="try{setCustomValidity('')} catch(e){}" required="required"></td><br />
				</tr>
			  <tr>
