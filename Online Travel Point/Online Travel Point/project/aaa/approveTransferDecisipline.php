...
<!-- ===========================================================================start content================================================================== -->
	 <div id="content" style="background: none repeat scroll 0% 0% rgb(80, 180, 188);">
	  <div class="post"></BR></BR></BR></BR></BR>
       <form name="frm" action="approveTransfer1.php" method="post" onSubmit="return register()"> 
            <caption><h2 style="padding-left:80px"> Prisoner Transfer Request Approve Form </h2></CAPTION></BR>
