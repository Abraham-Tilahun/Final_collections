...
<div id="content">
                  ...
                  <form  type="multipart/form-data" name="myForm" action="roomregistration.php" method="post" onsubmit="return (Register());" >
					    <h2><b>PRISON REGISTERATION FORM </h2><br><br><br>
						<table style color:black;>
           
		     <tr>
			 <td height="33">&nbsp;&nbsp;Blcko Name:</td>
			 <td><SELECT name="bn" style="width:100px">
			 <?php
		     while($search=mysql_fetch_array($retval))
			  ...
			  ?>
				...
				<tr>
					<td height="33"> &nbsp;&nbsp;Room Number :</td><td><input type="text" name="rn" size="18" pattern="[0-9]+"
					oninvalid="setCustomValidity('room Number is required')" onChange="try{setCustomValidity('')} catch(e){}" required="required"></td><br />
				</tr>
				<tr>
					<td height="33"> &nbsp;&nbsp;Floar Number :</td><td><input type="text" name="fn" size="18" pattern="[0-9]+"
					oninvalid="setCustomValidity('room Number is required')" onChange="try{setCustomValidity('')} catch(e){}" required="required"></td><br />
				</tr>
				<tr>
					<td height="33"> &nbsp;&nbsp;Number of Bed :</td><td><input type="text" name="nb" size="18" pattern="[0-9]+"
					oninvalid="setCustomValidity('room Number is required')" onChange="try{setCustomValidity('')} catch(e){}" required="required"></td><br />
				</tr>
			  <tr>
