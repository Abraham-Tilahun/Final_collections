...
?>
   <html>
      <head>
		...
		<title>CHANGE PASSWORD RELEASE OFFICER FORM</title>
...
<!--======================================Header end =========================================================================================================================-->
			<div id="menu">
				  <ul>
					<li><a href="releaseCase.php"title="" style="margin-left:155px;">Home</a></li> 
...
<!--================================================ start leftbar========================================================================================== -->
				...
				<ul>
					<li><a href="changePasswordReleaseOff.php">changePassword</a></li> 
...
<!--================================================================= start rightbar====================================================================== -->
	  <div id="rightbar" class="sidebar">
		 <h2>View</h2>
			<div class="back">
				<ul>
					<li><a href="viewPrisonerInfoReleaseOff.php"> View Prisoner information</a></li>
				   </ul>
	</div>
