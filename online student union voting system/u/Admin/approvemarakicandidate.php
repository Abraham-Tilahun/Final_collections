...
<div id="container">
		...
		?>
				...
				<legend align="center" style="color: #418cbe;font-size: 150%;">Total Election Result for Maraki campus</legend>
			  ...
			  <th>Selected As</th>
				...
				<?php 
				$sql=mysqli_query($conn,"select * from count where campus='marki' ORDER BY VOICE DESC ");
				$rank=1;
