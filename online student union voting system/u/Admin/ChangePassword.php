...
<div id="container">
		...
		include("../Admin/Adminmenu.php");
			   ...
			   <form method="POST" enctype="multipart/form-data">
			    ...
			    <tr><td colspan="2"><input type="submit" value="Change Password" name="change" class="myButton"></td></tr>
			    </table>
		    ...
		    if(isset($_POST['change']))
		    {
		        ...
		        $result = mysqli_query($conn,"SELECT * FROM user WHERE username='$username' and userid='$changeid'");
			    ...
			    {
		        $sql=mysqli_query($conn,"UPDATE user SET password='$newpassword' where username='$username' and userid='$changeid'");
		        if($sql)
		        {
