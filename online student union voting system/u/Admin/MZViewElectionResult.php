...
<div id="container">
       ...
       include("../Admin/Adminmenu.php");
		?>
				...
				<legend align="center" style="color: #418cbe;font-size: 150%;">Total Election Result for Melesi Zenawi campus</legend>
				...
				<?php 
				$sql=mysqli_query($conn,"select * from count where campus='Tseda' ORDER BY VOICE DESC ");
				$rank=1;
