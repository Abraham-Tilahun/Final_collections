<link rel="stylesheet" href="../bootstrap/font-awesome-4.1.0/css/font-awesome.min.css">
  <?php
	if(isset($_SESSION['username'])&& isset($_SESSION['password']))
	{
		?>
<ul>
    <li><a href="../Tsedavoter/Voter.php"title="home"><i class="fa fa-home"></i>Home</a></li>
	<li><a href="../Tsedavoter/votepresidantforallcampus.php" title="vote presidant for all campus"><i class="fa fa-hand-o-up"></i>vote presidant</a></li>
