...
function CountBack(secs) {
  if (secs < 0) {
	...
	window.location = "../Marakivoter/voteclosed.php"
    return;
  }
...
//Going to first page
echo "<center> <h3><a href='../Marakivoter/vote.php?page=1'>".'Privouse Page'."</a> ";
for ($i=1; $i<=$total_pages; $i++) {

echo "<a href='../Marakivoter/vote.php?page=".$i."'>".$i."</a> ";
};
// Going to last page
echo "<a href='../Marakivoter/vote.php?page=$total_pages'>".'Next Page'."</a></h3></center> ";
		?>
		    </div>
		<div id="footer">
			<?php
