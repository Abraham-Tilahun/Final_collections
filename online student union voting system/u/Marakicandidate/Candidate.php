...
include("../Marakicandidate/candidatemenu.php");
	...
	<li style="border-top: 1px solid white;"><a href="../Marakicandidate/viewcandidate.php"title="view candidate">View Candidates</a></li>
	<li style="border-top: 1px solid white;"><a href="../Marakicandidate/vote.php">Vote</a></li>
	<li style="border-top: 1px solid white;"><a href="../Marakicandidate/ViewElectionResult.php" title="view election Result">View Election Result</a> </li>
    <li><a href="../Marakicandidate/votepresidantforallcampus.php"title="vote presidant for all campus">vote presidant</a></li>
	<li style="border-top: 1px solid white;"><a href="../Marakicandidate/ChangePassword.php" title="change your password">Change Password</a> </li>
