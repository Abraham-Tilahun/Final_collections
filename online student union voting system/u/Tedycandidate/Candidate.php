...
include("../Tedycandidate/candidatemenu.php");
    ...
    <li style="border-top: 1px solid white;"><a href="../Tedycandidate/viewcandidate.php" title="view candidate">View Candidates</a></li>
     <li><a href="../Tedycandidate/vote.php"title="vote your representative">Vote</a></li>
	<li style="border-top: 1px solid white;"><a href="../Tedycandidate/ViewElectionResult.php"title="view election result">View Election Result</a> </li>
	<li><a href="../Tedycandidate/votepresidantforallcampus.php"title="vote presidant for all campus">vote presidant</a></li>
	<li style="border-top: 1px solid white;"><a href="../Tedycandidate/ChangePassword.php"title="change your password">Change Password</a> </li>
