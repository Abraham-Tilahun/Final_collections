...
include("../Tsedacandidate/candidatemenu.php");
		?>
				...
				<legend align="center" style="color: #418cbe;font-size: 30px;">Total Election Result for melese zenawi campus</legend>
				...
				<?php 
				$sql=mysql_query("select * from count where campus='Tseda' ORDER BY VOICE DESC ");
				$rank=1;
