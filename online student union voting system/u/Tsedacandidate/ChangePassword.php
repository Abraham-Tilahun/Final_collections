...
include("../Tsedacandidate/candidatemenu.php");
		?>
				...
				<div id="leftside">
					<div id="applyside">
					   ...
					   ?>	
													...
													<div id="rightside">
					<div style="background-color: #2d6fd2;color: #fff;b">
					<?php
					echo "<b>";
			   ...
			   <form method="POST" enctype="multipart/form-data">
			    <table>
			    <tr><td><b>Enter your UserName</td>
			    <td><b><input type="username"  name="username" class="textbox" value="<?php echo $_SESSION['username'];?>" readonly></td></tr>
			    <tr><td><b>Enter your existing password:</td><td><input type="password"  name="password" class="textbox"required></td></tr>
			    <tr><td><b>Enter your new password:</td><td><input type="password"  name="newpassword" class="textbox"required></td></tr>
			    <tr><td><b>Re-enter your new password:</td><td><input type="password"  name="confirmnewpassword" class="textbox"required></td></tr>
