...
include("../Tsedacandidate/candidatemenu.php");
   ...
   <li style="border-top: 1px solid white;"><a href="../Tsedacandidate/vote.php"title="vote representative for your campus">Vote</a></li>
   <li style="border-top: 1px solid white;"><a href="../Tsedacandidate/viewcandidate.php" title="view election candidate">View Candidates</a></li>
	<li style="border-top: 1px solid white;"><a href="../Tsedacandidate/ViewElectionResult.php" title="view election result">View Election Result</a> </li>
	<li><a href="../Tsedacandidate/votepresidantforallcampus.php" title="vote presidant for all campus">vote presidant</a></li>
	<li style="border-top: 1px solid white;">
	<a href="../Tsedacandidate/ChangePassword.php" title="change your password">Change Password</a> </li>
