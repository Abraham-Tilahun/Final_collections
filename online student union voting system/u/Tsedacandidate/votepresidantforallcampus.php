...
//Going to first page
echo "<center> <h3><a href='../Tsedacandidate/votepresidantforallcampus.php?page=1'>".'Privouse Page'."</a> ";
for ($i=1; $i<=$total_pages; $i++) {

echo "<a href='../Tsedacandidate/votepresidantforallcampus.php?page=".$i."'>".$i."</a> ";
};
// Going to last page
echo "<a href='../Tsedacandidate/votepresidantforallcampus.php?page=$total_pages'>".'Next Page'."</a></h3></center> ";
	}
else{
