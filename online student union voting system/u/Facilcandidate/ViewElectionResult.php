...
include("../Facilcandidate/candidatemenu.php");
		?>
				...
				<legend align="center" style="color: #418cbe;font-size: 150%;">Total Election Result for Facil</legend>
				...
				<?php 
				$sql=mysql_query("select * from count where campus='Facil' ORDER BY VOICE DESC ");
				$rank=1;
