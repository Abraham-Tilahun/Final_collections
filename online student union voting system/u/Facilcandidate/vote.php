...
function CountBack(secs) {
  if (secs < 0) {
    document.getElementById("cntdwn").innerHTML = "Request Date is Now Closed";
		window.location = "../Facilcandidate/voteclosed.php"
    return;
  }
...
//Going to first page
echo "<center> <h3><a href='../Facilcandidate/vote.php?page=1'>".'Privouse Page'."</a> ";
for ($i=1; $i<=$total_pages; $i++) {

echo "<a href='../Facilcandidate/vote.php?page=".$i."'>".$i."</a> ";
};
// Going to last page
echo "<a href='../Facilcandidate/vote.php?page=$total_pages'>".'Next Page'."</a></h3></center> ";
		?>
