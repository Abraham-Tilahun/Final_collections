			...
			<div id="content">
				<div class="login"style="margin-left:0%;">
					 ...
					 <form class="login-container" method="post" enctype="multipart/form-data">
					      	<p>User Name:<input type="text" placeholder="username" name="username" readonly></p>
					      	<p>Password:<input type="password" placeholder="********" name="password" id="password" required readonly></p>
					    	<p><input type="submit" value="Login" name="login" disabled></p>
					       ...
					       <P><a href="" style="text-decoration:none;font-style: italic;">Forget Password</a></P>
					       <span style="width: 10px;"><input type="reset" value="Reset" style="width: 150px;float: right;margin-top: -40px;" disabled/></span>
					  </form>
...
if(isset($_POST['username'])&&isset($_POST['password']))
	...
	if(isset($_POST['login']))
     {
		...
		//$pass=md5($upass);
		$result=mysql_query("Select * from user where (user.username='$uname' and 
	...
	$sql=mysql_query("delete from attempt");
			...
			header("location:Facilvoter/Voter.php");
...
<div id="showtime" style="margin-left: 70%;margin-top: -400PX;width: 30%;color: red;
