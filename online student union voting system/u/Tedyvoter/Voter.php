        ...
        <div id="slider" >
			...
			<img style="width:10%;" src="../IMG/votei.jpg" />
				...
				<div id="home-list" style="width:50%;background-color:#c4d0d2; margin-left:10%;">
					...
					Times New Roman;margin-bottom: 10px;padding-top: 6px;margin-top: 80%;
					margin-left:0%;"><b>  Voter Management Links</b></p>
	<li style="border-top: 1px solid white;"><a href="../Tedyvoter/viewcandidate.php"title="view candidate">View Candidates</a> </li>
    <li style="border-top: none;"><a href="../Tedyvoter/vote.php"title="vote representative for your campus">Vote</a></li>
	<li style="border-top: 1px solid white;"><a href="../Tedyvoter/ViewElectionResult.php"title="view election result">View Election Result</a></li>
	<li><a href="../Tedyvoter/votepresidantforallcampus.php" title="vote presidant for all campus">vote presidant</a></li>
	<li style="border-top: 1px solid white;"><a href="../Tedyvoter/ChangePassword.php"title="change password">Change Password</a></li>
	<li style="border-top: 1px solid white;"><a href="../Tedyvoter/viewvoter.php" title="view voter">view voter</a></li>
