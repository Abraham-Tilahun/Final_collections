...
<div id="container">
		...
		<div id="menu">
		<?php
include("../Tedyvoter/votermenu.php");
		?>
	</div>
				...
				<div id="leftside">
					<div id="applyside">
						<?php
							include("../Tedyvoter/votersidemenu.php");
					   ?>	
					</div>    
				</div>
				<div id="content">
...
function CountBack(secs) {
  if (secs < 0) {
	...
	window.location = "../Tedyvoter/voteclosed.php"
    return;
  }
...
$start_from = ($page-1) * $per_page;	
	$sql1=mysql_query("select * from user where role='Candidate'and campus='tedy' order by fname LIMIT $start_from, $per_page");
	...
	if($row1>0)
	{
			...
			$qry="select * from user where userid='$id' and campus='tedy'";
		...
		?>
				...
				<?php
$query = "select * from user where role='Candidate'and campus='tedy'";
...
//Going to first page
echo "<center> <h3><a href='../Tedyvoter/vote.php?page=1'>".'Privouse Page'."</a> ";
for ($i=1; $i<=$total_pages; $i++) {

echo "<a href='../Tedyvoter/vote.php?page=".$i."'>".$i."</a> ";
};
// Going to last page
echo "<a href='../Tedyvoter/vote.php?page=$total_pages'>".'Next Page'."</a></h3></center> ";
				?>
		    </div>
		<div id="footer">
			<?php
			include("../Tedyvoter/footer.php");
			?>
	</div>
		<?php
	}
