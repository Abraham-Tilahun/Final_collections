...
<div id="container">
		...
		<div id="menu">
		<?php
include("../Facilvoter/votermenu.php");
		?>
	</div>
				...
				<div id="leftside">
					<div id="applyside">
						<?php
							include("../Facilvoter/votersidemenu.php");
					   ?>	
					</div>    
				</div>
				<div id="content">
...
function CountBack(secs) {
  if (secs < 0) {
	...
	window.location = "../Facilvoter/voteclosed.php"
    return;
  }
...
$start_from = ($page-1) * $per_page;	
	$sql1=mysql_query("select * from user where role='Candidate'and campus='Facil' order by fname LIMIT $start_from, $per_page");
	...
	if($row1>0)
	{
			...
			$qry="select * from user where userid='$id' and campus='Facil'";
		...
		<?php
		$query = "select * from user where role='Candidate'and campus='Facil'";
...
//Going to first page
echo "<center> <h3><a href='../Facilvoter/vote.php?page=1'>".'Privouse Page'."</a> ";
for ($i=1; $i<=$total_pages; $i++) {

echo "<a href='../Facilvoter/vote.php?page=".$i."'>".$i."</a> ";
};
// Going to last page
echo "<a href='../Facilvoter/vote.php?page=$total_pages'>".'Next Page'."</a></h3></center> ";
		?>
			
		    </div>
		<div id="footer">
			<?php
			include("../Facilvoter/footer.php");
			?>
			<a name="bottom"></a>
	</div>
	<?php
