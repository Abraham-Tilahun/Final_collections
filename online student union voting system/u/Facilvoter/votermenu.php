 ...
 <?php
	if(isset($_SESSION['username'])&& isset($_SESSION['password']))
	{
		?>
<ul>
    <li><a href="../Facilvoter/Voter.php"title="home"><i class="fa fa-home"></i>Home</a></li>
	<li><a href="../Facilvoter/votepresidantforallcampus.php" title="vote representative for all campus"><i class="fa fa-hand-o-up"></i>vote presidant</a></li>
...
<li><a href="#bottom" title="click here to go down"  ><i class="fa fa-arrow-down"></i></li>
