...
<script type="text/javascript">
   ...
   <img src="../image/man.png" style="width: 100%; height:15%; float: up">
	...
	<div id="bodyw">
     <div id="bodyw-inner">
	   <div id='menu'>
	     <hr>
	     <ul>
	      <li ><a href="generate report.php" onclick="change_menu(this)" target="iframe1">Generate Report</a></li>
	     ...
	     <li ><a href="postpone.php" onclick="change_menu(this)" target="iframe1">Postpone Reserve</a></li>
	     <li ><a href="AddJourny.php" onclick="change_menu(this)" target="iframe1">add Journy</a></li>
	     <li ><a href="AddBus.php" onclick="change_menu(this)" target="iframe1">add Bus</a></li>
