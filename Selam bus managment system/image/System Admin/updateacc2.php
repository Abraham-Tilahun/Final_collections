...
<!--<form style="padding-left: 20px;" action="?" method="post">
	<input type="text" name="user_id" value="<?php echo $_GET['id']; ?>" hidden=true>
	<div class="container"><label class="labels">First Name *: </label><input id="first_name" onclick="username()" class="inputs" type="text" name="first_name" required="" value="<?php echo $row['first_name']; ?>"></div>
	<div class="container"><label class="labels">Last Name *: </label><input id="last_name" onchange="username" class="inputs" type="text" name="last_name" required="" value="<?php echo $row['last_name']; ?>"></div>
	<div class="container"><label class="labels">Age *: </label><input class="inputs" type="number" name="age" required="" value="<?php echo $row['age']; ?>"></div>
	<div class="container"><label class="labels">Date of Birth : </label><input class="inputs" type="date" name="DOB" value="<?php echo $row['DOB']; ?>"></div>
	<div class="container"><label class="labels">Sex *: </label><label><input type="radio" name="sex" value="F" checked="true"> Female</label> <label><input type="radio" name="sex" value="M" <?php if($row['sex'] == 'M') echo 'checked="true"'; ?>> Male</label></div>
	<div class="container"><label class="labels">City : </label><input class="inputs" type="text" name="city" value="<?php echo $row['city']; ?>"></div>
	<div class="container"><label class="labels">Phone No *: </label><input class="inputs" type="text" name="phone_number" required="" value="<?php echo $row['PHONE_NO']; ?>"></div>
	<div class="container"><label class="labels">Email : </label><input class="inputs" type="email" name="email" value="<?php echo $row['EMAIL']; ?>"></div>
	<div class="container"><label class="labels">Username *: </label><input id="username" class="inputs" type="text" name="username" required="" value="<?php echo $row2['username']; ?>"></div>
	<div class="container"><label class="labels">Password : </label><input class="inputs" type="password" name="password"></div>
	<div class="container"><label class="labels">Confirm : </label><input class="inputs" type="password" name="confirm_Password"></div>
	<div class="container" align="center"><input type="submit" name="submit" value="Submit"></div>
</form>-->
</div>
</body>
