...
<br><br>
    ...
    <table class="table table-bordered"style="width:400;margin-left:5px">
    ...
    <tbody>
			<?php
	$query=mysql_query("select * from post where posted_by ='$_SESSION[USER_ID]'")or die(mysql_error());
	...
	<?php  } ?>
		...
		mysql_query("insert into post values('','$post_content','$_SESSION[USER_ID]')")or die(mysql_error());
		...
		mysql_query("insert into comment values('','$comment_content',$post_id)")or die(mysql_error());
		header('location:index.php');
