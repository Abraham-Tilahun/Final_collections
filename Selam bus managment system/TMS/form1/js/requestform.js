$(function(){
	...
	function check_fname()
	{
		...
		{
		  fnam=true;
			$("#fname_error").html("please enter betwwen 3-15 character");
			$("#fname_error").show();
	  ...
	  {
	    fnam=true;
			$("#fname_error").html("first character must be capital");
			$("#fname_error").show();
			$("#fn").css("border-bottom","2px solid red");
	  }
		else 
	...
	function check_fathername()
	{
		...
		{
		  fathername=true;
			$("#fathername_error").html("please enter between 3-15 character");
			$("#fathername_error").show();
	  ...
	  {
	    fathername=true;
			$("#fathername_error").html("first character must be capital");
			$("#fathername_error").show();
			$("#mn").css("border-bottom","2px solid red");
	  }
		else 
	...
	function check_grandfathername()
	{
		...
		{
		  grandfathername=true;
			$("#grandfather_error").html("please enter betwwen 3-15 character");
			$("#grandfather_error").show();
	  ...
	  {
	    grandfathername=true;
			$("#grandfather_error").html("first character must be capital");
			$("#grandfather_error").show();
			$("#ln").css("border-bottom","2px solid red");
	  }
		else 
	...
	{
	     phone==true;
			$("#phone_error").html("it must be start 09");
			$("#phone_error").show();
	   ...
	   {
		   phone= true;
	   $("#phone_error").html("&nbsp; please enter 10 digit");
	   $("#phone_error").show();
	   $("#phon").css("border-bottom","2px solid red");
	   }
		else
