...
function check_fname()
	{
		...
		{
		  firstname=true;
			$("#fname_error").html("please enter betwwen 3-25 character");
			$("#fname_error").show();
	...
	function check_mname()
	{
		...
		{
		  midname=true;
			$("#mname_error").html("please enter betwwen 3-25 character");
			$("#mname_error").show();
	...
	function check_lname()
	{
		...
		{
		  lastname=true;
			$("#lname_error").html("please enter betwwen 3-25 character");
			$("#lname_error").show();
	...
	{
	     phone==true;
			$("#phone_error").html("please enter  valid character");
			$("#phone_error").show();
	   ...
	   {
		   phone= true;
	   $("#phone_error").html("&nbsp; please enter valid digit");
	   $("#phone_error").show();
	   $("#phon").css("border-bottom","2px solid red");
	   }
		else
