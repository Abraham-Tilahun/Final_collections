...
<input type="text" name="serach" placeholder="Enter Kebele ID..." required="required"/>
...
$query = mysql_query("SELECT *FROM shedule_request WHERE OPERATOR_ID = '$searchq' limit 1 ") 
