...
<?php
    $result_set = mysql_query("SELECT *FROM Account where STATUS='1'");
if(!$result_set)
	{
...
{
?>
<a href="activateaction.php?status=<?php echo $row['USER_ID'];?>" 
 class="act" onclick="return confirm(' Are You Sure Activate This User')"> activate?</a>
<?php
}
