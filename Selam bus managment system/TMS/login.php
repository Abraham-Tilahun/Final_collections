...
<div class="loginBox">
 <div class="glass">
   ...
   <form action="login.php" method="post" onSubmit = "return validate()" name="myform"target="<?php echo(htmlentities($_SERVER['PHP_SELF'])); ?>" id="userlog">
   <div class="inputBox">
   <input type="text"name="uname"placeholder="<?php echo htmlspecialchars($lang['username']);?>"id="uname">
