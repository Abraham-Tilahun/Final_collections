...
<br><br>
    ...
    <div class="controls">
    <textarea rows="3" name="post_content"disabled="disabled" class="span6" placeholder="Whats on Your Mind"></textarea>
    </div>
    </div>
   
    <div class="control-group">
    <div class="controls">
    <button name="post" type="submit"disabled="disabled" class="btn btn-info"><i class="icon-share"></i>&nbsp;Post</button>
    </div>
    </div>
    ...
    <table class="table table-bordered"style="width:100;margin-left:-5px">
    ...
    <td width="40"><a class="btn btn-danger" href="#<?php echo '?id='.$id; ?>"><i class="icon-trash"></i></a></td>
    </tr>
