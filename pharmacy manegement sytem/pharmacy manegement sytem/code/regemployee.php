...
<option>storecoordinator</option><option>cashier</option></select><br><br>
...
$res=mysql_query("INSERT INTO employee values('$fname','$lname','$id','$sex','$age','$salary','$address') ");	
if(!$res)
	{
...
echo' <meta content="3;regemployee.php" http-equiv="refresh" />'; 
	...
	{
	echo"<font color='green'><p class='right'>You have succefully registered employee !!!</p></font>";
echo' <meta content="3;regemployee.php" http-equiv="refresh" />'; 
	}
	}
mysql_close($conn);
