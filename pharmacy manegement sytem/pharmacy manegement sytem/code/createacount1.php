...
function validate()
{
    a= document.create.accountid.value
    u= document.create.username.value
	pa= document.create.password.value
	cp= document.create.confirmpassword.value
  if(a=="")
  {
  alert("User's Acount id  is empty");
  return false;
  }
 if(u=="")
  {
 ...
 if( pa== "" )
   {
     alert( "Empty password. Please  enter user  password" );
     return false;
   }
   var minlength=4;
...
return false;
  ...
  var nupass=document.create.password.value;
 
var nurepass=document.create.confirmpassword.value;

  if(nupass!=nurepass)
  {
  alert("Password  doesn't match. Please re-enter password correctly");
return false;
  }
}
</script>
...
<form name="create"  action="create.php" onSubmit="return validate();"  method="post">
<fieldset><legend align="center"> <font face='monotype corsiva' size='5px' color="red">Create Acount Form</font></legend>&nbsp;<br><br>
<font align="center" color="black">

<b><font size="3px">
Acount Id:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="accountid" id="accountid" placeholder=".....acount id..." size="20%"><br><br> 
User Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="username" id="uname"  placeholder="..user name.." size="20%">
&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
<b><font size="3px">
Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="password" id="password" size="20%"><br><br>
Confirm Password:<input type="password" name="confirmpassword" id="confirmpassword" size="20%"><br><br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<input type="submit" value="Sign Up" name="create">&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="Cancel" name="cancel">
</fieldset>
</form>
</td>
