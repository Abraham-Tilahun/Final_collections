...
function checkvalidation()
{
	  ...
	  var cid = document.getElementById(cid');
		 ...
		 if( isNumeric( cid, "Please fill your Id")){
		 if(lengthRestriction(cid, 1, 10,"for your Id")){
...
<li><a href="cashier.php">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
	 &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
	 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
	 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
	 Home<font color="red"></a></li>
 <li><a href="notification.php">Fetch Order<font color="red"></a></li>
 
<li><a href="changepass4.php">Change Password<font color="red"></a></li>
 <li><a href="logout.php" id="logout"><b>Logout</a></li></div>
</td>
</tr>
...
<form action="print.php" method="post" name="printtt" onSubmit="return checkvalidation()">
<fieldset align="center"><legend align="center"> <font face='monotype corsiva' size='5px' color="red">Printing saled drug form</font></legend>&nbsp;<br><br>
<font align="center" color="black">
<table align="center">
<tr><td align="center">
<b>Customer Id:&nbsp;&nbsp;<input type="text" name="cid" id="cid" size="10">&nbsp;&nbsp;&nbsp;

<input type="submit" name="search" value="search">&nbsp;&nbsp;&nbsp;<input type="reset" value="Cancel" name="cancel">
