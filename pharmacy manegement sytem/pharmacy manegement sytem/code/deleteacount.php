...
function checkvalidation()
{
 var aid = document.getElementById('aid');
		 ...
		 if( isalphaNumeric( aid, "Please fill the account id in numbered only")){
...
$result = mysql_query ("SELECT accountid FROM account");
...
{
$aid=$_POST['aid'];
$result=mysql_query("SELECT * from account WHERE accountid='$aid' ");
...
<?php
	...
	{
$del=mysql_query("DELETE FROM account WHERE accountid='$aid' ");
if(!$del)
		{
