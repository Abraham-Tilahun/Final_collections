	   ...
	   var bnumber = document.getElementById('bnumber');
		...
		var shelfno = document.getElementById('shelfno');
		 ...
		 if(lengthRestriction(cname, 3, 30,"for company name")){
			...
			if( isNumeric( bnumber, "Please fill bach number in leters  only")){
...
<table align="center" width=1170 height="600px" border=0>
<tr><td width="1164" height=20px  colspan=2>
<p align="center">&nbsp;</p></td>
</tr>
...
<b><font size="3px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shelf-No:&nbsp;&nbsp;<input type="text" name="shelfno" id="shelfno"  placeholder="..shelf number.." size="20%"><br><br>
...
$db1=mysql_select_db("pharmacy",$connection);
...
$exdate=$_POST['edate'];
$res=mysql_query("INSERT INTO drug values('$accountid','$dname','$cname','$bnumber','$quantity','$unitprice','$shelfno','$exdate') ");
