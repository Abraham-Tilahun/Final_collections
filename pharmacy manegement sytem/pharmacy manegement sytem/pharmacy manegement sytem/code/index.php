...
<li><a href="help1.pdf">Help</a></li>
<li><a href="login1.php" id="login"><b>Login</a></li>
 </div>
</td>
</tr>
<td  height=300px width=150px  valign=top border="0" bgcolor="blueblack">
<table border="0"  width="200" height="200" class="menu-bar" align="center">
<td width="230" height="350" bgcolor="blueblack"><font color="black" face="monotype corsiva" size="3">
<h2 align="center"><marquee>Red Cross Pharmacy </marquee></h2><img src="images/photo.jpg" width="300" height="300" align='left'>
...
<center><font face="monotype corsiva" size="6" color="#CC0099">Well Come to Red Cross pharmacy </font></h2></center>
<br>
<img src="images/47.jpg" width="500" height="250" >
</td>


<td width=100px bgcolor="#99FFCC" height=500>
<table border=0 width=150px height=250px>
<tr>
<td border="0" height="400" width="125" bgcolor="blueblack">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="black" face="monotype corsiva" size="6">
<?php
echo(Date(" F d,Y"));
?>
<img src="" height="250" width="200" name="demo" >
<font face="French Script MT" size="5" color="black">Red Cross  pharmacy Works For giving service for the society!!!</b></font><br><br>
...
<table align="center"><tr>
  <td color=#047B5A><font face="Times New Roman" color="blueblack" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Red Cross Pharmacy Sys 2016. &copy; Copy right All Rights Reserved
 &nbsp; &nbsp; &nbsp; &nbsp;
