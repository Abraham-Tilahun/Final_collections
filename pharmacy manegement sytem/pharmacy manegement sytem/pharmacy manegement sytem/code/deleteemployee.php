...
function checkvalidation()
{
	  ...
	  var eid = document.getElementById('eid');
		 ...
		 if( isNumeric( eid, "Please fill your Id")){
...
<form action="deleteemployee.php" method="post" name="check" onSubmit="return checkvalidation()">
<fieldset><legend align="center"> <font face='monotype corsiva' size='5px' color="red">Delete employee form</font></legend><br><br>
<font align="center" color="black">
<?php
$conn=mysql_connect("localhost","root","");
$db1=mysql_select_db("pharmacy",$conn);

$result = mysql_query ("SELECT employeeid FROM employee");
 echo '<label><b>Employee Id:&nbsp;&nbsp;&nbsp;</label>';
 echo '<select id="eid" name="eid">';
...
{
$empid=$_POST['eid'];
$result=mysql_query("SELECT * from employee where employeeid='$empid' ");
...
<?php
	...
	{
$del=mysql_query("DELETE FROM employee WHERE employeeid='$empid' ");
if(!$del)
		{
		echo"<font color='green' size='5px'><p class='wrong'>Deletion failed!!!</p></font>";
echo' <meta content="3;deleteemployee.php" http-equiv="refresh" />';
	}
	else
	{

echo"<font color='#006699' size='5px' face='monotype corsiva'><p class='right'>You have succefully delete employee from your data base!!!</p></font>";
echo' <meta content="3;deleteemployee.php" http-equiv="refresh" />'; 
	}
}}
mysql_close($conn);
