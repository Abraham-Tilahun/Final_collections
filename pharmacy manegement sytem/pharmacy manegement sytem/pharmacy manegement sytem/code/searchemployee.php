...
function checkvalidation()
{
	  ...
	  var fname = document.getElementById('fname');
		 ...
		 if(!isNaN( fname, "Please fill eid")){
...
<h2 align="center">Red Cross Pharmacy </h2><img src="images/photo.jpg" width="230" height="380" align='left'>
...
<form action="searchemployee.php" method="post" name="search" onSubmit="return checkvalidation()">
<fieldset><legend align="center"> <font face='monotype corsiva' size='5px' color="red">Search employee information Form</font></legend>&nbsp;<br><br>
...
$result = mysql_query("SELECT * FROM employee where fname='{$fname}' ");
echo"<br><br>";
if(mysql_num_rows($result)>0)
{
echo "<table id='vtable' style='width:600px;border:1px solid #336699;border-radius:10px;' align='center'><font color=white>";
echo"<tr>";
echo"<td bgcolor='#FFFFCC'><font color='red'>firstname</font></td>";
echo"<td bgcolor='#FFFFCC'><font color='red'>lastname</font></td>";
echo"<td bgcolor='#FFFFCC'><font color='red'>employeeid</font></td>";
echo"<td bgcolor='#FFFFCC'><font color='red'>Sex</font></td>";
echo"<td bgcolor='#FFFFCC'><font color='red'>Age</font></td>";
echo"<td bgcolor='#FFFFCC'><font color='red'>Salary</font></td>";
echo"<td bgcolor='#FFFFCC'><font color='red'>Address</font></td>";
echo"</tr>";
...
echo "<td>" . $row['age'] . "</td>";
 ...
 echo "<td>" . $row['address'] . "</td>";
  ...
  echo"</table>";
   ...
   echo '<center>';
  echo '<font face="monotype corsiva" size="5"color="red">Such employee is not found !!</font>'; 
...
<table align="center"><tr><td color=#047B5A><font face="Times New Roman" color="blueblack" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pharmacy Sys 2016. Copyright All Rights Reserved
 &nbsp; &nbsp; &nbsp; &nbsp;
