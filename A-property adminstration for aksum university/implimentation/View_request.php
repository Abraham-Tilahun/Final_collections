  ...
  <div id="main">
	...
	<div id="menubar">
      <ul id="menu">
		...
		<li><a href="Request purchase.php">Request purchase</a></li>
		<li><a href="Approve Disposal.php">Approve Disposal</a></li>
		<li><a href="Approve transfer.php">Approve transfer</a></li>
		<li><a href="View_request.php">View_request_purchase</a></li>
...
<h3>Calender</h3>
	 ...
	 <h3
	  ...
	  <table width="220" height="36">
        <tr>
          <th width="204" bgcolor="#none" scope="row"><span class="style17">Collegedean Page </span></th>
        </tr>
      </table>
	  <div class="sidebar">
