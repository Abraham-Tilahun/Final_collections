...
<body>
 ...
 <h3>Calender</h3>
	 ...
	 <table width="215" height="150">
        <tr>
          <th width="204" height="70" bgcolor="	#808080" scope="row"><span class="style1">About_us</span></th>
      </table>
	...
	<div>
	  ...
	  <div id="content1">
        <div class="content_item">
		  ...
		  <h1>Background of the Aksum University property Administration system </h1> 
	      <p class="style12"><span class="style13">Aksum University is found in Aksum town which is the 
		  capital city of the afar National Regional State. The  establishment of this Aksum University to be one of the higher 
		  institutions was in 1999ec. Aksum university have around 7 thousands including the 
		  extenetion program now triying to be 
		  the institute of creating qualified students </span></p>
