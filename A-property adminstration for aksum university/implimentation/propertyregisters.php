  ...
  <div id="main">
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li><a href="storemanregisterproperty.php">property register</a></li> 
      ...
      <ul class="slideshow">
       <li class="show"><img width="350" height="350" src="images/pc.jpg"/></li>
		...
		<li><img width="975" height="350" src="images/devo.jpg"/></li>
              ...
              <tr>
                <th width="0" height="0" colspan="0" scope="row"><marquee direction="">
                  </marquee>
                    <marquee direction="">
                    <p>&nbsp;</p>
                    </marquee></th>
...
<div style="width:600px; height:500px; margin:0 auto; position:relative; border:2px solid rgba(0,0,0,0); -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:25px; -webkit-box-shadow:0 0 18px rgba(0,0,0,0.4); -moz-box-shadow:0 0 18px rgba(0,0,0,0.4); box-shadow:0 0 18px rgba(0,0,0,0.4); margin-top:20px; color:#000000;">
  ...
  <form id="form1" name="login" method="POST" action="registerpropertyregisterproperty.php" onsubmit="return validateForm()">
 ...
 <div style="float:left;" ><strong><font color="white" size="2px">Registration property</font></strong></div>
...
<a href="../user.php" title="Close"><img src="..images/bof_02.jpg"></a></div> 
  ...
  <br><br><br>
		 ...
		 <tr>
	     <td class='para1_text' width="220px"><font color="red">*</font> prop_expirydate:</td>
		 <td><input type="text"  name="prop_expirydate" id="prop_expirydate" onclick="ds_sh(this);" placeholder="prop_expirydate" autocomplete="off">
	     </tr>
    <td>&nbsp;</td>
	<br>
    <td><input type="submit" name="Register" value="Register property" class="button_example"/></td>
