...
<body>
  <div id="menubar">
      <ul id="menu">
		...
		<li><a href="Request_property_to_finance.php">Request Prchase</a></li>
		<li><a href="View.request.php">View request</a></li>
		<li ><a href="Notificatin_vicpresident.php">Notification </a></li>
	...
	<div id="menubar1">
	  ...
	  <div class="sidebar">
	   ...
	   <div id="content">
		...
		<?php
		include("requestpurchascollege.php");
		?></div>
	  </div>
