...
<p align="center"><input type="submit" name="update" value="Change" style="width:70px" Onclick="return check(this.form);"/>&nbsp;&nbsp;
<input type='reset' value='Reset'style="width:70px;"></p><br><br>
</table> 
  </form>
	  </div>
