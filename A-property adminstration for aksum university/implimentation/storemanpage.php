...
<div id="menubar1">
	...
	<div>
      <ul class="slideshow">
	    <li class="show"><img width="900" height="300" src="images/storeman.jpg"/></li>
        <li class="show"><img width="900" height="300" src="images/storeman.jpg"/></li>		  
      </ul>   	 
  </div>
	  ...
	  <div id="content1">
        <div class="content_item">
		  <h1><center style="color:green;"></center></h1>
              <div class="content_image">
	        <li><img width="900" height="300"src="images/pc.jpg" alt="image1"/>
	      </div>		  
