...
<td style='height:30px;	color:#000;	font-weight:bold;background-color:white;'><font color='black'><?php
						...
						{
						?>
                       			  <a href="approved_dip.php?status=<?php echo $row['User_id'];?>" onclick="return confirm('Really you want approve <?php echo $description?>');">
						...
						{
						?>
                       			<a href="approved_dip.php?status=<?php echo $row['User_id'];?>" onclick="return confirm('Really you want disapproved (<?php echo $description?>)');"> 
