...
<td style='height:30px;	color:#000;	font-weight:bold;background-color:white;'><font color='black'><?php
						...
						?>
                        		...
                        		<img src="images/inde.jpg" id="view" width="16" height="16" alt="" />Your request is approved </a>
                        <?php
						}
						if(($status)=='1')
						{
						?>
                       			 ...
                       			 <img src="images/inde.jpg" width="18" id="view" height="18" alt=""  />Your request is approved</font></a>
                        <?php
						}
                        ?>
