...
<body>
  <div id="menubar">
      <ul id="menu">
        <li><a href="Vicpresident page.php">Home</a></li>
		<div class="dropdown">
		 <div class="dropdown-content">	
		  </div>
        </div>
		<li><a href="View.request.php">View request Purchase</a></li>
		<div style="float:right">
		<div class="dropdown"><button class="dropbtn" color=""><b></b><img width="15" height="15" src="images/default.png"/></button>
		 <div  style="float:right" class="dropdown-content">
          <a href="Changing_passward.php">Change Password</a>		 
...
<h3>Calender</h3>
	 ...
	 <h3
	  ...
	  <table width="220" height="36">
        <tr>
          <th width="204" bgcolor="#none" scope="row"><span class="style17">Vice_president page</span></th>
        </tr>
      </table>
	  <div class="sidebar">
   ...
   <div style="background-color:#cccccc;width:700px; height:600px; margin:0 auto; position:relative; border:2px solid rgba(0,0,0,0); -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:25px; -webkit-box-shadow:0 0 18px rgba(0,0,0,0.4); -moz-box-shadow:0 0 18px rgba(0,0,0,0.4); box-shadow:0 0 18px rgba(0,0,0,0.4); margin-top:20px; color:#000000;">
    ...
    <form id="form1" name="Request property" method="POST" action="vice_presidentdb.php" onsubmit="return validateForm()">
  ...
  <a href="userpage.php" title="Close"><img src="images/back.png"></a></div> 
     ...
     <tr>
    <td colspan="10"><div style="font-family:Arial, Helvetica, sans-serif; color:#none; font-size:20px;">
	<table cellpadding="5" align="center"cellspacing="10">
     ...
     <br>
		 ...
		 <td><input type="username" name="username" size="35"required ="enter your username"pattern="[A-Za-z]{3,21}"required x-moz-errormessage="enter letter from 4 to 21 character for your username" ></td>
	     </tr>
	 <tr>
		 ...
		 <td><input type="User_id" name="User_id" size="35" required x-moz-errormessage="User_id" ></td>
	      ...
	      <tr>
	     <td class='para1_text' width="220px"><font color="red">*</font> ItemName:</td>
		 ...
		 <td><input type="unitmeasure" name="unitmeasure" size="35" required x-moz-errormessage="unitmeasure" ></td>
	     </tr>
		 ...
		 <td><input type="text"  name="Req_Date" id="Req_Date" size="35"  onclick="ds_sh(this);" placeholder="Request Date" autocomplete="off">
	     </tr>
		  <tr>
	     <td class='para1_text' width="220px"><font color="red">*</font>Description:</td>
		 <td><textarea required name="description" id="description"rows="5"cols="30" > </textarea><br><br></td>
		 </tr>
		  <tr>
            <th height="50" colspan="2" align="center" size="34" scope="row"><label>
