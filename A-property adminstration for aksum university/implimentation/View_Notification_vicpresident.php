...
<th style='height:30px;	color:#000;	font-weight:bold;background-color:336699;'><font color='white' size='3'>Approved Request</th>
</tr>      
<?php
mysql_select_db('storem');
mysql_select_db('storem',mysql_connect('localhost','root',''))or die(mysql_error());
$result = mysql_query("SELECT * FROM request_purchase where status='1' ");
//$result = mysql_query("SELECT * FROM request UNION SELECT * FROM request_purchase where status='1' ");
...
<td style='height:30px;	color:#000;	font-weight:bold;background-color:white;'><font color='black'><?php
						...
						?>
                        		  ...
                        		  <a href="approverequetion.php?status=<?php echo $row['User_id'];?>" onclick="return confirm('Really you want approve <?php echo $description?>');">
						...
						?>
                       			   ...
                       			   <a href="approverequetion.php?status=<?php echo $row['User_id'];?>" onclick="return confirm('Really you want approve <?php echo $description?>');">
                        		<img src="images/wrong.png" id="view" width="16" height="16" alt="" /> approved </a>
                        <?php
						}
                        ?>
						</td>						
