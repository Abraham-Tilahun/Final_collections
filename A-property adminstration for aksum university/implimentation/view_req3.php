...
<?php 
	echo'<p valign="bottom" align="center"><form><input type="button" style="width:20%;height:30px;color:#000;
...
mysql_select_db('storem');
mysql_select_db('storem',mysql_connect('localhost','root',''))or die(mysql_error());
$result = mysql_query("SELECT * FROM request_purchase where status='2' ");
