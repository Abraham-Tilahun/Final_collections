  ...
  <a href="userpage.php" title="Close"><img src="images/back.png"></a></div> 
	...
	<table cellpadding="15" align="center"cellspacing="15">
	 ...
	 <tr>
		 ...
		 <td><input type="Item_name" name="Item_name" size="30" required ="enter Item Name"pattern="[A-Za-z]{3,21}"required x-moz-errormessage="enter letter from 4 to 21 Item Name" ></td>
	     </tr><tr>
		 ...
		 <tr>
	     <td class='para1_text' width="22px"><font color="red">*</font>Requestedby:</td>
		 <td><select name="requested_by" required>
	     <option></option>
				<option>Engineering</option>
				<option>Health scienece</option>
				<option>Other social science</option>
				<option>Natural and computational science</option>
				<option>FBE</option>
				<option>Communication and language</option>
