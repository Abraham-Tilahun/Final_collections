...
<td style='height:30px;	color:#000;	font-weight:bold;background-color:white;'><font color='black'><?php
						...
						?>
                        		...
                        		<img src="images/wrong.png" id="view" width="16" height="16" alt="" />This property you can transfer to the user </a>
                        <?php
						}
						if(($status)=='2')
						{
						?>
                       			 ...
                       			 <img src="images/right.png" width="16" id="view" height="16" alt=""  /> This property you can transfer to the user</font></a>
