...
<h3>Calender</h3>
	 ...
	 <h3
	  ...
	  <table width="220" height="36">
        <tr>
          <th width="204" bgcolor="#none" scope="row"><span class="style17">College dean Principles </span></th>
        </tr>
      </table>
	  <div class="sidebar">
          <div class="sidebar_item">
	...
	<div>
      <ul class="slideshow">
        <li class="show"><img width="900" height="250" src="images/ededent.jpg"/></li>
        <li class="show"><img width="900" height="250" src="images/ededent.jpg"/></li>		
      </ul>   	 
	 </div>
	  ...
	  <div id="content1">
		  ...
		  <center><h1 style="color:#2E8B57;"></h1> </center>
	        <li><img width="955" height="300"src="images/uuu.jpeg" alt="image1"/>
	      </div>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
