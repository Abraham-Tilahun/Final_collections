...
<body>
	<div id="menubar">
      <ul id="menu">
        <li><a href="Financedirectory page.php">Home</a></li>
		<div class="dropdown">
 ...
 <h3>Calender</h3>
	 ...
	 <h3
	  ...
	  <table width="220" height="36">
        <tr>
          <th width="204" bgcolor="#none" scope="row"><span class="style17">Finance_directory Page </span></th>
        </tr>
      </table>
	  <div class="sidebar">
	...
	<div>
      <ul class="slideshow">
       <li class="show"><img width="900" height="250" src="images/finanvcent.jpg"/></li>
       <li class="show"><img width="900" height="250" src="images/finanvcent.jpg"/></li>		
      </ul>   	 
	 </div>
	  ...
	  <div id="content1">
        <div class="content_item">
	      ...
	      <li><img width="955" height="300"src="images/breee.jpg" alt="image1"/>
	      </div>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
