...
<body>
	<div id="menubar">
      <ul id="menu">
		...
		<li ><a href="Notifiction.php">Notification  
 ...
 <h3>Calender</h3>
	 ...
	 <h3
	  ...
	  <table width="220" height="36">
        <tr>
          <th width="204" bgcolor="#none" scope="row"><span class="style17">users page </span></th>
        </tr>
      </table>
	  <div class="sidebar">
	...
	<div>
      ...
      <ul class="slideshow">
	   <li><img width="975" height="350" src="images/userss.jpg"/></li>
		<li><img width="975" height="350" src="images/userss.jpg"/></li>
	  ...
	  <div id="content1">
		...
		<h1><center style="color:#2E8B57;"></center></h1>
	      <li><img width="955" height="300"src="images/1.jpg" alt="image1"/>
        </div>
	  </div>
	  <ul id="menu">
