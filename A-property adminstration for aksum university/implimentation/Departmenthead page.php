...
<body>
  <div id="menubar">
      <ul id="menu">
		...
		<li ><a href="Notification_department.php">Notification </a></li>
...
<br><br>
	...
	<div>
      <ul class="slideshow">
		<li class="show"><img width="900" height="300" src="images/department.jpg"/></li>
        <li class="show"><img width="900" height="300" src="images/department.jpg"/></li>		
        ...
        <div class="content_item">
		 <div class="content_item">
		  <center><h1 style="color:#2E8B57;"></h1> </center>
	        <li><img width="955" height="300"src="images/amu.jpg" alt="image1"/>
	      </div>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
