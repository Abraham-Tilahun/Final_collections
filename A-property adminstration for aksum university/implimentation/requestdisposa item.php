...
{
mysql_query("INSERT INTO request_disposal (Fname,Mname,Lname,User_id,Item_name,unitmeasure,Qauntity,Req_Date,description,request_type,requested_by) 
   VALUES ('$Fname','$Mname','$Lname','$User_id','$Item_name','$unitmeasure', '$Qauntity','$Req_Date','$description','Request_Disposal','user')");
    echo '<script language="javascript">';
    echo 'alert("Request Disposal is successfully Send..."); location.href="Request disposal.php"';
    echo '</script>';
}
