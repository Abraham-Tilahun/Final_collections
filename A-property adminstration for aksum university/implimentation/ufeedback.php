...
<a href="http://24timezones.com/world_directory/addis_ababa_local_time.php" target="_blank" title=" " style="text-decoration: none">
	  ...
	  <ul id="menu">
        ...
        <li></li>
	    <li></li>
	    <li class="current"><a href="ufeedback.php">Feedback </a></li>
	  </ul>
	  <ul id="menu">
	...
	<div>
      <ul class="slideshow">
        <li class="show"><img width="975" height="350" src="images/hom.jpg"/></li>
	  ...
	  <div id="content1">
        <div class="content_item"><form action='fed_back.php' method='post'>
		  <table width="507" height="199">
            <tr>
              <th width="304" align="right" scope="row"> Name </th>
              <td width="191"><label>
                <input type="text" name="FirstName" />
              </label></td>
            </tr>
            <tr>
              <th height="51" align="right" scope="row">EpiId</th>
              <td><label>
