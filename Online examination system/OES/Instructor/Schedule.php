...
<title>AUOES Schedule page</title>
		...
		<div id="left">
	        ...
	        <div id="TabbedPanels1" class="TabbedPanels">
	          <ul class="TabbedPanelsTabGroup">
	            <li class="TabbedPanelsTab style1" tabindex="0">Create Exam Schedule</li>
	            <li class="TabbedPanelsTab style2 style3" tabindex="0">Display Exam Schedule</li>
              </ul>
...
do {  
?>
                                <option value="<?php echo $row_Recordset1['exam_name']?>"><?php echo $row_Recordset1['exam_name']?></option>
                                <?php
