...
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="https://mail.google.com/a/dbu/edu.et">Web Mail</a></td>
      ...
      <table width="405" height="124" bordercolor="#CCCCCC" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic;"><br/><br /><br/><br /><br /><br/><br /><br/><br /><br />
	  <tr>
          <th width="685" height="66" scope="row">Confirm Item Status here</th>
        </tr>
	  <tr>
	       <th align="right" scope="row" >Item Name:</th>
		   <td ><select name="ItemName" style="width:140px;"  maxlength="5">
		   <?php


$result=mysql_query("select * from borrow_item Where BorowedItemStatus='On Use' ")or die(mysql_error);
...
?>
		...
		<tr>
          ...
          <td valign="bottom" background="1"><label>
		   ...
		   <td ><select name="Emp" style="width:140px;"  maxlength="5">
		   <?php
