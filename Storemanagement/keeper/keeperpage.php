	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li><a href="kviewitem.php">New Approved Items </a></li>
         <li><a href="kviewitemreturn.php">Approve for return</a></li>
         <li><a href="return.php">Returned Item</a></li>
	...
	<div>
      <ul class="slideshow">
	   ...
	   <li><img width="990" height="350" src="images/laptopp.jpg"/></li>
		...
		<tr bgcolor="#FF0000" align="center"><th bgcolor="#FFCC33"><blink>&nbsp;&nbsp;<font size="+2" color="#0033FF" face="MONOtype Corsiva">Well come to Keeper Page</font></blink></th></tr>
