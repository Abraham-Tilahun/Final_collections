...
<div id="menubar">
      <ul id="menu">
        ...
        <li class="current"><a href="chreturnitem.php">Check Return Item </a></li>
...
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="https://mail.google.com/a/dbu/edu.et">Web Mail</a></td>
	  ...
	  <td width="177"><frameset>
        ...
        <tr>
          <th align="right" scope="row">Return Date</th>
          <td><input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" name="start" id="sd" value="" maxlength="10" readonly="readonly" /></td>
        </tr>
        <tr>
