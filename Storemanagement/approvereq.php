...
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="https://mail.google.com/a/dbu/edu.et">Web Mail</a></td>
	  ...
	  <div id="content">
        ...
        <tr>
          ...
          <th width="110" align="right" valign="bottom" scope="row">Employee Id </th>
          <td width="143" align="left" valign="bottom"><label>
            <input name="co" type="text" id="c" />
          </label></td>
        </tr>
        <tr>
	...
	<div="footer">
        ...
        <li class="style9  style18">
          <h4 class="style19" align="center">Copyright©2015 Debre Berhan University Store Management System </h4>
        </li>
</ul>
	<!--close sidebar-->
</body>
