...
<body>
  <div id="main">
    <div id="header">
      <!--close banner-->
      <img src="images/last2.png" alt="image1" width="1230" height="118"/></div>
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li class="current"><a href="regkeeper.php">Register Kepper </a></li>
...
clock24_48332.daylight('ET'); clock24_48332.refresh();
   ...
   <marquee behavior="scroll" direction="up" onmouseover="this.stop();" onmouseout="this.start();">
	  ...
	  <!--close sidebar_container--><div id="menubar1">
	  ...
	  <div id="content">
	    <form action='register_keeper.php' method='post'><table width="556" height="371">
        <tr>
          <th height="95" colspan="2" valign="top" scope="row"><p><img src="images/bof_02.jpg" alt="" width="61" height="20" /> new keeper here..<img src="images/newuser.png" alt="" width="48" height="48" /> </p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>          </th>
        </tr>
        <tr>
        ...
        <tr>
          <th height="19" align="right" scope="row" Value="+251">Phone Number </th>
          <td><label>
            <input name="PhoneNumber" type="text" id="PhoneNumber" Value="+251" />
          </label></td>
        </tr>
        <tr>
        ...
        <tr>
          <th height="28" colspan="2" align="center" scope="row"><label>
