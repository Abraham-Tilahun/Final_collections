...
<head>
  ...
  <style type="text/css">
<!--
.style8 {color: #666666; font-weight: bold; font-style: italic;}
  ...
  <div id="main">
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li class="current"><a href="viewreport.php">View Report </a></li>
...
<table border="0" bgcolor="#666666" cellspacing=2 cellpadding=4 class="clock24st" style="line-height:50px; line-width:215px; padding:0;">
