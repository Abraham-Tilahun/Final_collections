	...
	<div>
      <ul class="slideshow">
	   ...
	   <li><img width="990" height="350" src="images/laptopp.jpg"/></li>
		...
		<table bgcolor="#663300" height="35" width="985">
		<tr bgcolor="#FF0000" align="center"><th bgcolor="#FFCC33"><blink>&nbsp;&nbsp;<font size="+2" color="#0033FF" face="MONOtype Corsiva">Well come to LogIn Page</font></blink></th></tr>
		</table>
		 <form action='loginn.php' method='post'>
 <table width="985" height="415" align="center" bgcolor="#FFFFFF" bordercolor="#3399FF">
          <tr>
            <th width="985" bgcolor="#FFFFFF" scope="row"></th>
          </tr>
          <tr bgcolor="#993300">
            <th height="145" colspan="3" scope="row" bgcolor="#FFFFFF" ><div align="center" class="style31"><span class="style17 "><font color="#666699" size="+2">Login Here</font></span></div></th>
          </tr>
          <tr>
            <td height="20" colspan="2" class="style23 style25" align="right"><font size="+1" color="#3399FF">&nbsp;&nbsp;* User Name:</font></td>
            <td width="985" align="left"><input name="uname" type="text"  id="uname" size="25"/>            </td>
          </tr>
          <tr>
            <td height="49" colspan="2" name="pword" id="pword" align="right"><span class="style23 style25"><font size="+1" color="#3399FF">* Password:</font></span></td>
            <td align="left"><input name="pword" type="password" size="25"/>             </td>
          </tr>
          <tr>
            
            <td><label> </label>
                <div align="right">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Login" name='Submit' style="background-color:#ffff99; border-left-style:double; font-size:18px;color:#400000; border:groove" />
              </div>              </td>
          ...
          <tr bgcolor="#CCCCCC">
            <td height="41" colspan="3" align="center"><span class="style30 style3 style8"><em><a href="fpass.php" ><font color="#000000" >Forgot Password?</font> </a></em></span>               </td>
          </tr>
		 <tr bgcolor="#CCCCCC">
            <td height="73" colspan="3" align="right"><span class="style30 style3 style8"><em><font color="#999999"</em></span>               </td>
          </tr>
		  </table>
