	 ...
	 <div id="content">
      ...
      <table width="399">
        ...
        <tr>
          ...
          <th height="26" align="left" scope="row"><input class="mine_text_field_7" name="date" id="txtfrom" size="20"  readonly="readonly" type="text" placeholder='Request date'/>
<a href="javascript:NewCssCal('txtfrom','yyyymmdd')"><img src="images/at.png" width="20" height="21" border="0" /></a></th>
	  ...
	  <!--close sidebar_container-->
		...
		<tr><th bgcolor="#FFFFFF" height="30" width="1300" valign="top">
