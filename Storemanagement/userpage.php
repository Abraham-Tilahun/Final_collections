...
//clock24_48332.daylight('ET'); clock24_48332.refresh();
        ...
        <li><a href="mission.php">Our service </a></li>
			 ...
			 <p>&nbsp;</p>
			 <p>&nbsp;</p>
	<!---   <table width="212" height="384" bgcolor="#FFFFFF">
               <tr>
   ...
   <marquee behavior="scroll" direction="up" onmouseover="this.stop();" onmouseout="this.start();">
               ...
               <tr> 
                 ...
                 <th width="230" height="50" colspan="2" scope="row" bgcolor=""#FFFFFF"><h1><blink >Well Come to User Page</blink></h1><img width="200" height="175" src="images/BestImage.jpg"/><br />
	...
	<div>
      <ul class="slideshow">
	   ...
	   <li><img width="990" height="350" src="images/laptopp.jpg"/></li>
		...
		<tr bgcolor="#FF0000" align="center"><th bgcolor="#FFCC33"><blink>&nbsp;&nbsp;<font size="+2" color="#0033FF" face="MONOtype Corsiva">Well come to User's Page</font></blink></th></tr>
