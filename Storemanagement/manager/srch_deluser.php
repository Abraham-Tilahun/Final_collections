...
echo '<table cellpadding="13" cellspacing="20" id="resultTable" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic ">
<tr  style="i">the following item(s) is(are) borrowed by you</tr>
<tr bgcolor="#33FF00" style="margin-bottom:1px;">
<th bgcolor="blue" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic ">EmpId</th>
<th>First Name</th>
<th>Last Name</th>
<th>User Name</th>
</tr>';
...
$cc=$row['LastName'];
$dd=$row['username'];
echo '<th style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic ">EmpId:</th>';
