...
$res=mysql_query($sql) or die("query error".mysql_error());
   ...
   ?>
	  ...
	  <div id="content">
	  <form action="srch_deleteuser.php " method="post">
	    <table width="556" height="34" bordercolor="#CCCCCC" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic;"><br /><br /><br /><br /><br /><br />
          <tr>
            <th height="42" colspan="2" align="center" valign="bottom" scope="row"><label>Delete User here... </label></th>
          </tr>
          <tr>
