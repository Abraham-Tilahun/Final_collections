	  ...
	  <div id="content">
		...
		echo '<input name="id" type="hidden" value="'.$msg .'" />';
			...
			while($row = mysql_fetch_array($result))
  			{
			echo 'Emp Id<input type="text" name="empid" value="'. $row['EmpId'] .'">'; 
			  echo '<br>';
			  echo '<input type="text" name="empname" value="'. $row['Employee Name'] .'">'; 
			  echo '<br>';
			  echo '<input type="text" name="iid" value="'. $row['ItemId'] .'">'; 
			  echo '<br>';
			  echo '<input type="text" name="iname" value="'. $row['Item Name'] .'">'; 
			  echo '<br>';
			  echo'<input type="text" name="qut" value="'. $row['quantity'] .'">'; 
			echo '<br>';
			echo 'Borrowed Date:';
			...
			echo 'Are you sure you want to approve this request?';
			echo '<br>';
			echo '<br>';
