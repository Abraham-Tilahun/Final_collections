...
<div id="menubar">
      <ul id="menu" style="font-color:white">
         ...
         <li><a href="signup_2.php">Create Account</a></li>
...
?>
	  <form action='viewuloan.php' method='post'>
      <table width="358">
            <tr>
   ...
   ?>    
	...
	<ul id="menu">
        ...
        <li class="style9  style18">
          <h2 class="style19">Copyright©2015 Debre Berhan University Store Management System </h2>
        </li>
</ul>
	<!--close sidebar-->
</body>
