...
<head>
  <title>DBU store managment system</title>
...
<div id="menubar">
      <ul id="menu">
		...
		<li><li><a href="login.php">logout</a></li></li>
...
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="https://mail.google.com/a/dbu/edu.et">Web Mail</a></td>
      ...
      <p>
        <?php echo $me;?>
		<!--$me="You have successfully Return the Item";
		<!--close content-->
      </p>
	  ...
	  <td width="177"><frameset>
        ...
        <tr>
          ...
          <td><input type="text" class="w8em format-y-m-d highlight-days-67 range-low-today" name="start" id="sd" value="" maxlength="10"  /></td>
        </tr>
        <tr>
