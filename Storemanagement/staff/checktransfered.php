	  ...
	  <div id="content">
        <div class="content_item">
		  ...
		  <p>
		    ...
		    <?php
			echo "<form action='checktransfered.php' method='post'>";
			if (isset($_GET['id']))
		...
		echo '<input name="id" type="hidden" value="'.$msg .'" />';
			...
			echo '<br>';
			$id=$_GET['id'];
			$result = mysql_query("SELECT * FROM transfereditem");

			while($row = mysql_fetch_array($result))
  			{
			echo '<font size="+2" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Emp Id</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="empid" value="'. $row['EmpId'] .'">'; 
			  echo '<br>';
			  ...
			  echo '<br>';
			  echo '<font size="+2" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Item Id</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="iid" value="'. $row['ItemId'] .'">'; 
			  echo '<br>';
			  ...
			  echo '<br>';
			  echo'<font size="+2" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quantity</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="qut" value="'. $row['quantity'] .'">'; 
			echo '<br>';
			echo '<font size="+2" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Borrowed Date:</font>';
			...
			echo '<br>';
			echo '<br>';
			echo '<input name="ok" type="submit" value="Register" align="center" />';
			echo '</form>';
		}	
