...
?>
	  <form action="cancelreq.php " method="post">
       <table width="405" height="124" bordercolor="#CCCCCC" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic;"><br /><br />
        <tr>
        ...
        <tr>
          ...
          <th width="195" align="left" valign="bottom" scope="row"><label><br />
              <input name="eid" type="text" id="EmployeeId" value="<?php echo $empid; ?>" readonly="readonly"/>
          </label></th>
        </tr>
        <tr>
