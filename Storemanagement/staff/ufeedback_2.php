...
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="https://mail.google.com/a/dbu/edu.et">Web Mail</a></td>
	  ...
	  <div id="content">
        <div id="log"><br/><br/><br/><br/><br/><br/>
        <form action='fed_back.php' method='post'>
		  <table width="507" height="199" style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:16px; border-color:#999999; font-style:italic; font-stretch:expanded; border-radius:20px; border:thin;">
            <tr>
              <th width="304" align="right" scope="row">Email </th>
              <td width="191"><label>
                <input type="text" name="FirstName" />
              </label></td>
            </tr>
            <tr>
              <th height="51" align="right" scope="row">EmpId</th>
              <td><label>
                <input name="EmployeeId" type="text" id="EmployeeId" readonly="readonly" value="<?php echo $empid ?>" />
              </label>            
            </tr>
            <tr>
              <th height="51" align="right" valign="top" scope="row">content</th>
              <td valign="top"><label>
                <label>
                ...
                <label></label></tr>
            <tr>
              <th height="64" colspan="2" align="right" scope="row"><label>
                <input name="Submit" type="submit" class="style8" value="Send" />
                <input name="Submit2" type="reset" class="style8" value="Cancel" />
              </label></th>
            </tr>
          </table><p><?php echo $message ?></p>
        </form>
        </div>
	  </div>
      	  <!--close sidebar_container-->
