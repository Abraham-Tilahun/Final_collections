...
<tr><td bgcolor="#CCCCCC" style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:16px; font-style:italic;" height="30px" width='800' colspan='2' align="center">ChangePassword</td></tr>
...
if(lengthRestriction(old, 2, 30,"for your oldpassword")){
if(lengthRestriction(neww, 3, 30,"for your newpassword")){
if(lengthRestriction(confi, 3, 30,"for your Confirmpassword")){
	return true;
	}}
	}
...
<p align="center"><img src="../images/lock.jpg" height="150" width="350"></p>
</fieldset>
</form>	
	<?php
