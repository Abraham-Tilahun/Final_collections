...
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="https://mail.google.com/a/dbu/edu.et">Web Mail</a></td>
      ...
      <table width="400" align="left" style="font-family:Times New Roman, Times, serif; font-size:16px; border-radius:30px; font-style:italic; padding-left:30px; "><br/><br/> <br /><br/>
	    <tr>
          <th width="205" height="66" scope="row" bgcolor="#CCCCCC">Transfer Item here </th>
        </tr>
		<tr>
...
?>
        ...
        <tr>
          ...
          <td><input name="quanti"  align="left"type="text" id="quanti" pattern="\d{1,15}" title="Please Fill The Item Quantity" required/></td>
        </tr>
        <tr>
...
<tr>
      ...
      </table><p style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:18px; background:#009900;">&nbsp;&nbsp;
      <?php echo $message ?></p></form>	</div>
	  </div>
	  <!--close sidebar_container-->
<div id="footer">
