...
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="https://mail.google.com/a/dbu/edu.et">Web Mail</a></td>
	  ...
	  <div id="content">
		...
		<table width="495" style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:16px; font-style:italic; border-color:#CCCCCC;">
        <tr>
	  ...
	  <td width="177">
        <tr>
          ...
          <td width="310"><label>
            <input name="eid" type="text" id="eid" value="<?php echo $empid ?>" readonly="readonly"  pattern="\D{2,15}" title="Please Fill The Item Name" onKeyPress="return isText(event)" required/>
            <br />
            <br />
          </label></td>
        </tr>
        <tr>
          ...
          <td width="310"><label>
            <input name="ename" type="text" id="eid" value="<?php echo $empname ?>" readonly="readonly"  pattern="\D{2,15}" title="Please Fill The Item Name" onKeyPress="return isText(event)" required/>
            <br />
            <br />
          </label></td>
        </tr>
         <tr>
		   ...
		   <td ><select name="itemid" style="width:140px;"  maxlength="5"  pattern="\w{3,15}" title="Please select the The Item Id" onKeyPress="return isText(event)" required>
		   <?php
...
?>
          ...
          <tr>
		   ...
		   <td ><select name="quantity" style="width:140px;"  maxlength="5"  pattern="\w{3,15}" title="Please select the The Item Id" onKeyPress="return isText(event)" required>
		   <?php
$result=mysql_query("select * from borrow_item Where EmpId='$empid' and BorowedItemStatus='On Use'")or die(mysql_error);
while($row=mysql_fetch_array($result)){
