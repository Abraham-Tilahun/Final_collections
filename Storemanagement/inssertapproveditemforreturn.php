...
$sql=mysql_query("SELECT * FROM approvedforreturn where ItemId='$Iid'");//VALUES ('$name', '$Iid', '$pr','$Qaun', '$mod')"); 
$count=mysql_num_rows($sql);
// If result matched $myusername and $mypassword, table row must be 1 row

if($count<='0'){

mysql_query("INSERT INTO `approvedforreturn` VALUES ('$name', '$Iid', '$Qaun', '$stat', '$emp')"); 
$message="Successfully added...";
}
else
{
$q="SELECT Qauntity FROM approvedforreturn where ItemId='$Iid' and ItemName='$name'";
$ry=mysql_query($q);
if(!$ry){
...
include('additem_2approvedforreturn.php');
?>