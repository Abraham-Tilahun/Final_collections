                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3><?php echo $ln_viewAnnouncementTopTitle;?></h3>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                if (isset($_GET["page"])) {
                                    ...
                                    if ($page == "" || $page == "1") {
                                        ...
                                        $st = mysql_query("SELECT Property_manager.F_NAME, property_manager.PROFILE, announcement.* FROM announcement INNER JOIN property_manager ON announcement.ID=property_manager.ID WHERE PREPARE_FOR='asset_manager' and EXPIRE_DATE>='$day' limit $page1,$lim");
                                        echo mysql_error();
                                        $im = '';
...
'</div>';
                                                                     ...
                                                                     $st = mysql_query("SELECT Property_manager.F_NAME, property_manager.PROFILE, announcement.* FROM announcement INNER JOIN property_manager ON announcement.ID=property_manager.ID WHERE PREPARE_FOR='asset_manager' and EXPIRE_DATE>='$day' limit 0,$lim");
                                        echo mysql_error();
                                        $im = '';
                                        if (mysql_num_rows($st) > 0) {
                                            while ($row = mysql_fetch_assoc($st)) {
  ...
  $query = mysql_query("SELECT * FROM announcement WHERE PREPARE_FOR='asset_manager' and EXPIRE_DATE>='$day' ");
                                echo mysql_error();
