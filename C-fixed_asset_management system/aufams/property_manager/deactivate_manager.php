...
if (isset($_GET['lan'])) {
    ...
    if ($langu == 'english') {
        ...
        header("location: deactivate_manager.php");
                        ...
                        <nav>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        <li><a href="deactivate_manager.php?lan=amharic"  rel="facebox"> Amharic</a></li>
                                        <li><a href="deactivate_manager.php?lan=english"  rel="facebox"> English</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><?php echo $ln_propertyMangerViewUserTitle; ?></h2>
                                    ...
                                    <div class="x_content">
                                        ...
                                        if (isset($_POST['deactivate'])) {
                                            $idf = $_POST['userId'];
                                            $st = mysql_query("UPDATE fixed_asset_manager SET STATUS=1 where ID=$idf");
                                            if (!$st) {
                                                echo mysql_error();
                                            } else {
                                            ...
                                            <tbody>
                                                ...
                                                while ($res = mysql_fetch_assoc($resul)) {
                                                    ...
                                                    <tr class="record">
                                                        ...
                                                        <td><a title="Click To Deactivate <?php echo ucfirst($res['F_NAME']); ?>" rel="facebox"><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModals<?php echo $res['ID']; ?>"><i class="fa fa-trash"></i></button></a>&nbsp;</td>
                                    ...
                                    <?php
                                    $qu = mysql_query("SELECT * FROM fixed_asset_manager WHERE STATUS=0");
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <i class="fa fa-2x fa-quote-left-circle-o"></i>  Are You Sure to Deactivate <?php echo ucfirst($ro['F_NAME']); ?>?
