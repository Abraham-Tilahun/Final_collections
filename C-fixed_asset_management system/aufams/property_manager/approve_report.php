                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="profile.php" class="site_title"><i class="fa fa-paw"></i> <span><?php echo $ln_propertyManger; ?></span></a>
                        </div>
                        ...
                        <nav>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        <li><a href="approve_report.php?lan=amharic"  rel="facebox"> Amharic</a></li>
                                        <li><a href="approve_report.php?lan=english"  rel="facebox"> English</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3><?php echo $ln_approveReportTop;?></h3>
                            </div>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        if(isset($_POST['rejected'])){
                                            $repid=$_POST['repid'];
                                            $results=mysql_query("UPDATE report set STATUS=2 WHERE R_ID=$repid");
                                            if($results){
                                                
                                            echo "<div class='alert alert-success'>" .
                                            "<button class='close' data-dismiss='alert'>&times;</button>" .
                                            "<strong>".$ln_success."</strong>".$ln_rejectReportSuccess .
                                            "</div>";
                                            }
                                        }
                                        if(isset($_POST['approved'])){
                                            $repid=$_POST['repid'];
                                            $results=mysql_query("UPDATE report set STATUS=1 WHERE R_ID=$repid");
                                            if($results){
                                                
                                            echo "<div class='alert alert-success'>" .
                                            "<button class='close' data-dismiss='alert'>&times;</button>" .
                                            "<strong>".$ln_success."</strong>".$ln_approveReportSuccess .
                                            "</div>";
                                            }
                                        }
                                        ?>
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo $ln_approveReportPrepareBy;?></th>
                                                    <th><?php echo $ln_approveReportPrepareType;?></th>
                                                    <th><?php echo $ln_approveReportPrepareDescription;?></th>
                                            ...
                                            <tbody>
                                                <?php
                                                $res = mysql_query("SELECT fixed_asset_manager.F_NAME, fixed_asset_manager.M_NAME, report.* FROM report INNER JOIN fixed_asset_manager ON report.ID=fixed_asset_manager.ID WHERE report.STATUS=0 ORDER BY PREP_DATE DESC");
                                                if (!$res) {
                                                    echo mysql_error();
                                                } else {
                                                    ...
                                                    while ($row = mysql_fetch_assoc($res)) {
                                                        ...
                                                        echo "<td>" . ucfirst($fname) . ' ' . ucfirst($mname) . "</td>";

                                                        echo "<td>" . ucwords($rtype) . "</td>";
                                                        echo "<td>" . $des . " </td>";
                                                        echo "<td>" . $date . " </td>";
                                                        echo '<td>';
                                                        
                                                 echo'<a data-toggle="tooltip" data-placement="top" title="'.$ln_download.'" href="'.$cont.'"><button class="btn-primary"><i class="fa  fa-download"></i></button></a>
                                                    <a data-toggle="tooltip" data-placement="top" title="'. $ln_approve.'"> <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal' . $row['R_ID'] . '"><i class="fa fa-check-circle"></i></button></a>&nbsp;
                                                    <a data-toggle="tooltip" data-placement="top" title="'. $ln_reject.'"><button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModals' . $row['R_ID'] . '"><i class="fa fa-thumbs-o-down"></i></button></a>&nbsp; </td>';
...
<?php     
 $qu = mysql_query("SELECT fixed_asset_manager.F_NAME, fixed_asset_manager.M_NAME, report.* FROM report INNER JOIN fixed_asset_manager ON report.ID=fixed_asset_manager.ID WHERE report.STATUS=0 ORDER BY PREP_DATE DESC");
                                                
           while ($ro = mysql_fetch_assoc($qu)) {
                ?>
                <div id="myModals<?php echo $ro['R_ID']; ?>" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Are You sure to reject This Report?</h4>
                            </div>
                            <div class="modal-body">
                                <div class="text-center">
                                
                                </div>
                                <form class="form-horizontal form-label-left" method="post" name="request" action="">
                                    <div class="item form-group">

                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="repid" value="<?php echo $ro['R_ID']; ?>" type="hidden">
                                        </div>
                                    </div>
...
<?php     
 $qu = mysql_query("SELECT fixed_asset_manager.F_NAME, fixed_asset_manager.M_NAME, report.* FROM report INNER JOIN fixed_asset_manager ON report.ID=fixed_asset_manager.ID WHERE report.STATUS=0 ORDER BY PREP_DATE DESC");
           ...
           while ($ro = mysql_fetch_assoc($qu)) {
                ?>
                <div id="myModal<?php echo $ro['R_ID']; ?>" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Are You sure to Approve This Report?</h4>
                            </div>
                            <div class="modal-body">
                                <div class="text-center">
