...
<?php echo $ln_language; ?>
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        <li><a href="activate_user.php?lan=amharic"  rel="facebox"> Amharic</a></li>
                                        <li><a href="activate_user.php?lan=english"  rel="facebox"> English</a></li>
                                    </ul>
                                </li>
...
if (isset($_POST['deactivate'])) {
    $idf = $_POST['userId'];
    $st = mysql_query("UPDATE asset_user SET STATUS=0 where ID=$idf");
    if (!$st) {
        echo mysql_error();
    } else {
...
$resul = mysql_query("SELECT * FROM asset_user WHERE STATUS=1");
...
<?php
$qu = mysql_query("SELECT * FROM asset_user WHERE STATUS=1");
