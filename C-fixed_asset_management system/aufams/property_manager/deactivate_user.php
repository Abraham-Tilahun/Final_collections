...
<?php echo $ln_language; ?>
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        <li><a href="deactivate_user.php?lan=amharic"  rel="facebox"> Amharic</a></li>
                                        <li><a href="deactivate_user.php?lan=english"  rel="facebox"> English</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><?php echo $ln_generalAssetUser;?></h2>
...
if (isset($_POST['deactivate'])) {
    $idf = $_POST['userId'];
    $st = mysql_query("UPDATE asset_user SET STATUS=1 where ID=$idf");
    if (!$st) {
        echo mysql_error();
    } else {
...
$resul = mysql_query("SELECT * FROM asset_user WHERE STATUS=0");
while ($res = mysql_fetch_assoc($resul)) {
    ?>
                                                    <tr class="record">
                                                        ...
                                                        <td>
                                                            <a title="Click To Deactivate <?php echo ucfirst($res['F_NAME']); ?>" rel="facebox"><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModals<?php echo $res['ID']; ?>"><i class="fa fa-trash"></i></button></a>&nbsp;
